...
public class SourceFilterParser extends Parser {
	...
	public static class MessageTrueHeadingInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageTrueHeadingIn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MessageDraughtInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageDraughtIn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MessageShiptypeInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageShiptypeIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SourceBasestationInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitSourceBasestationIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageImoInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageImoIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageNavigationalStatusInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageNavigationalStatusIn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class SourceIdInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitSourceIdIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SourceRegionInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitSourceRegionIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageCallsignInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageCallsignIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageLongitudeInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageLongitudeIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SourceTypeInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitSourceTypeIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageLatitudeInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageLatitudeIn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MessageNameInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageNameIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageSpeedOverGroundInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageSpeedOverGroundIn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MessageCourseOverGroundInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageCourseOverGroundIn(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MessageMmsiInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageMmsiIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SourceCountryInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitSourceCountryIn(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class MessageIdInContext extends FilterExpressionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof SourceFilterVisitor ) return ((SourceFilterVisitor<? extends T>)visitor).visitMessageIdIn(this);
			else return visitor.visitChildren(this);
		}
	}
