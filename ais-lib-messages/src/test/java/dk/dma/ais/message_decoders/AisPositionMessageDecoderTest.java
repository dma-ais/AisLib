...
import dk.dma.ais.message.json_decoder_helpers.CommonFieldDecoderHelper;
import dk.dma.ais.message.json_decoder_helpers.decoded_objects.DecodedAisFieldObject;
import dk.dma.ais.message.json_decoder_helpers.decoded_objects.DecodedAisPosition;
import dk.dma.ais.message.json_decoder_helpers.enums.PositionAccuracy;
import dk.dma.ais.message.json_decoder_helpers.enums.Raim;
import dk.dma.ais.message.json_decoder_helpers.enums.SpecialManoeuvreIndicator;
import dk.dma.ais.message.json_decoder_helpers.enums.SyncState;
import dk.dma.ais.message.json_decoder_helpers.message_decoders.AisPositionMessageDecoder;
