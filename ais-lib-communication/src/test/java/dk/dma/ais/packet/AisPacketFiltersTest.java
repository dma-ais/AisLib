...
/**
 ...
 public class AisPacketFiltersTest {
     ...
     public void testParseExpressionFilterGlobs() {
         assertFilterExpression(true, p1, "m.name like D*");
         assertFilterExpression(true, p1, "m.name LIKE DI*");
         assertFilterExpression(true, p1, "m.name LIKE DI?NA");
         assertFilterExpression(true, p1, "m.name ~ D*A");
         assertFilterExpression(true, p1, "m.name ~ 'DIA*'");

         assertFilterExpression(true, p1, "m.cs like OVF?");
         assertFilterExpression(true, p1, "m.cs like O*");
         assertFilterExpression(false, p1, "m.cs like M*");

         assertFilterExpression(false, p1, "m.name like a*");
         assertFilterExpression(false, p1, "m.name LIKE a*");
         assertFilterExpression(false, p1, "m.name LIKE DI??NA");
         assertFilterExpression(false, p1, "m.name ~ a*");
         assertFilterExpression(false, p1, "m.name ~ 'a*'");
     }
